      ...
      >
        ...
        <div className="mt-4 flex gap-2">
          <button
            ...
            className="flex-1 rounded-xl border border-slate-200/80 bg-slate-100/70 py-2 px-3 text-xs font-bold text-slate-700 hover:bg-slate-200 transition dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
          >
            Auto-fill Admin Credentials (admin@paperbolt.com)
          </button>
        </div>
